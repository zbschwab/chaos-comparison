...
double rk45_dp_step(state_dp_t *s, cons_dp_t *c, double dt) {
    ...
    printf("scale_theta = %lf, %lf, scale_omega = %lf, %lf, e0 = %lf, %lf, e1 = %lf, %lf, err_norm = %lf\n", scale_theta_1, scale_theta_2, scale_omega_1, scale_omega_2, e0_1, e0_2, e1_1, e1_2, err_norm);
    ...
    printf("step complete. dt = %lf, err_norm = %lf, rk4 = %lf, %lf, %lf, %lf, rk5 = %lf, %lf, %lf, %lf\n", dt, err_norm, b4.theta_1, b4.theta_2, b4.omega_1, b4.omega_2, b5.theta_1, b5.theta_2, b5.omega_1, b5.omega_2);
